...
export default function About() {
    ...
    return (
        <div className="section">
            ...
            <img src="profile_pic.jpg" alt="portrait of benjamin" style={{width: '30%', minWidth: 150, borderRadius: '50%', boxShadow: '0px 0px 25px grey', marginTop: 30, marginBottom: 30, marginLeft: 'auto', marginRight: 'auto'}} />

            <table style={{ textAlign: 'start', marginLeft: 'auto', marginRight: 'auto', paddingLeft: 20, paddingRight: 20 }}>
                <colgroup>
